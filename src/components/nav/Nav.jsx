...
import "./navs.css"
import { AiOutlineHome,AiOutlineUser,AiOutlineBook,AiFillProject } from 'react-icons/ai';
...
function Nav() {
  ...
  return (
    <nav>
      ...
      <a href="#services" onClick={()=>setActiveNave('#services')} className={activeNav=='#services'?'active':""}><AiFillProject/></a>
